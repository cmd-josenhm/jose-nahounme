...
export function getSeo(pathname) {
  ...
  if (path === '/') {
    seo = { ...seo, title: 'Graphiste designer et développeur frontend à Cotonou | José Nahounmè', description: 'Je suis José Nahounmè, graphiste designer et développeur frontend à Cotonou. Je crée des identités visuelles et des sites web performants pour les entreprises au Bénin.', keywords: 'graphiste designer Bénin, développeur frontend Cotonou, designer graphique Bénin, création site web Bénin, UI UX Cotonou, freelance web Bénin', structuredData: { '@context': 'https://schema.org', '@graph': [person, { '@type': 'WebSite', '@id': `${SITE_URL}/#website`, name: SITE_NAME, url: SITE_URL, inLanguage: 'fr-BJ', publisher: { '@id': `${SITE_URL}/#person` } }] } };
  } else if (path === '/about') {
